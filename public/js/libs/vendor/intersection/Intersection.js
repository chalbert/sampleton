...
Intersection.intersectBezier2Bezier2 = function(a1, a2, a3, b1, b2, b3) {
    ...
    c10 = new twoD.Point2D(a1.x, a1.y);
    ...
    c20 = new twoD.Point2D(b1.x, b1.y);
...
Intersection.intersectBezier2Rectangle = function(p1, p2, p3, r1, r2) {
    var min        = r1.min(r2);
    var max        = r1.max(r2);
    var topRight   = new twoD.Point2D( max.x, min.y );
    var bottomLeft = new twoD.Point2D( min.x, max.y );
        ...
        for ( var x = 0; x < xRoots.length; x++ ) {
            ...
            if ( Math.abs(test) < norm0 ) {
                ...
                if ( Math.abs(test) < norm1 ) {
                    result.appendPoint( new twoD.Point2D( xRoots[x], yRoots[y] ) );
                }
            }
        }
    }
