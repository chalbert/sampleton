...
define(['jquery'], function($) {
  ...
  $.fn.filedrop = function(options) {
    var bind = function(){
      this.bind({
        'drop.filedrop': drop,
        'dragenter.filedrop': dragEnter,
        'dragover.filedrop': dragOver,
        'dragleave.filedrop': dragLeave
      });
      $(document).bind({
        'drop.filedrop': docDrop,
        'dragenter.filedrop': docEnter,
        'dragover.filedrop': docOver,
        'dragleave.filedrop': docLeave
      });
    }

    if (options === 'unbind') {
      this.unbind('.filedrop')
